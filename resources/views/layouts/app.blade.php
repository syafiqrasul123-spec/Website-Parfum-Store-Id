    ...
    <div class="container-fluid p-0 d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="d-flex gap-1 me-1">
                <button onclick="window.history.back()" class="btn btn-nav-circle btn-sm rounded-circle d-flex align-items-center justify-content-center" title="Kembali">
                    <i class="bi bi-arrow-left"></i>
                </button>
                <button onclick="window.history.forward()" class="btn btn-nav-circle btn-sm rounded-circle d-flex align-items-center justify-content-center" title="Maju">
                    <i class="bi bi-arrow-right"></i>
                </button>
            </div>

            <!-- Brand Logo -->
            <a class="navbar-brand fw-bold text-white m-0" href="{{ url('/') }}" style="font-size: 1.05rem;">
            ...
            <ul class="navbar-nav me-auto align-items-center my-2 my-md-0">
                ...
                @auth
                    @if(Auth::user()->email === 'admin123@gmail.com')
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-danger" href="{{ route('products.index') }}">Dashboard Admin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-white" href="{{ route('admin.orders.index') }}">🛒 Kelola Pesanan</a>
                        </li>
                    @endif
                @endauth
            </ul>
            ...
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                ...
                @else
                    ...
                    <li class="nav-item me-2">
                        <a class="nav-link position-relative p-1" href="{{ route('cart.index') }}" title="Keranjang Belanja">
